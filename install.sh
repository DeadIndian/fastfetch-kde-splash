...
# Fork Fastfetch KDE Splash Screen Installer
# MIT License - based on herzane's fastfetch-kde-splash
...
case "$INPUT_LAYOUT" in
    2|full) LAYOUT="full" ;;
    3|info) LAYOUT="info" ;;
    4|sequential) LAYOUT="sequential" ;;
...
# Target directory
TARGET_DIR="$HOME/.local/share/plasma/look-and-feel/fork-fastfetch-splash"
